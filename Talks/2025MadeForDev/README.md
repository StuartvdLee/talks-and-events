...
In this session we'll build an MCP server from scratch using the MCP C# SDK. We'll look at how to build tools, prompts and resources and how to leverage these using GitHub Copilot.
...
- The Office
- [dunder-mifflin](https://github.com/StuartvdLee/dunder-mifflin)
